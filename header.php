    ...
    <div class="container-fluid">
                ...
                <div class="search-top">
                    <form action="" method="GET" class="mt-4">
                        <div class="form-group">
                            <input type="text" name="keyword" placeholder="Bạn cần tìm gì nào ...?"
                                class="form-control search-input">
                            <button class="btn btn-danger btn-input"><i class="fa fa-search"
            ...
            <div class="tt">
                ...
                <div class="menu-ad">
                    ...
                    <ul>
                        <li class="text-white">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false" style="margin-left: -65px;">
                                    &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; <?php echo $_SESSION['user']['ho_ten'] ?>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="#">
                                        <img src="<?php echo BASE_URL.'/'. $_SESSION['user']['hinh'] ; ?>" alt=""
                                            class="image-me mb-2" width="110px" height="100px">
                                    </a>
                                    <a class="dropdown-item" href="<?php echo BASE_URL ?>tai_khoan/edit_password.php"
                                        style="color: black;">Đổi mật khẩu</a>
                                    <a class="dropdown-item" href="<?php echo BASE_URL ?>tai_khoan/update.php"
                                        style="color: black;">Cập nhật tài khoản</a>
                                    <a class="dropdown-item" href="<?php echo BASE_URL ?>tai_khoan/forgot_password.php"
                                        style="color: black;">Quên mật khẩu</a>
                        ...
                        <li>
                            <a href="<?php echo BASE_URL ?>tai_khoan/logout.php"
                                onclick="return confirm('Bạn chắc chắn muốn đăng xuất ?')">|&ensp; Đăng xuất</a>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li class="text-white">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown"
                                    ...
                                    <?php echo $_SESSION['admin']['ho_ten'] ?> (AD)
                                </a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="#">
                        ...
                        <li>
                            <a href="<?php echo BASE_URL ?>tai_khoan/logout.php"
                                onclick="return confirm('Bạn chắc chắn muốn đăng xuất ?')">|&ensp;&ensp; <i
                                    class="fa fa-window-close" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_URL ?>admin/trang_chinh"
                                onclick="return confirm('Bạn chắc chắn muốn vào trang Admin ?')">|&ensp; <i
        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-items-center menu">
                <ul>
                    <li><a href="<?php echo BASE_URL ?>index.php"><i class="fa fa-home" aria-hidden="true"></i>
                            &ensp;Trang chủ</a></li>
                    ...
                    <li><a href="<?php echo BASE_URL ?>lien_he/lien_he.php"><i class="fa fa-phone"
                                aria-hidden="true"></i>&ensp;Liên Hệ</a></li>
                </ul>
            </div>
        </div>

        <div class="row banner mt-2">
            <div class="col-md-8 banner-left" style="margin-left: -8px;">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="<?php echo BASE_URL; ?>/public/image/slide0.png"
                                alt="First slide" height="419px">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo BASE_URL; ?>/public/image/slide5.jpg"
                                alt="Second slide" height="419px">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo BASE_URL; ?>/public/image/slide3.jpg"
                                alt="Third slide" height="419px">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo BASE_URL; ?>/public/image/slide7.png"
                                alt="Third slide" height="419px">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo BASE_URL; ?>/public/image/slide1.jpg"
                                alt="Third slide" height="419px">
                        </div>
                    </div>
            ...
            <div class="col-md-4 banner-right">
                <div class="row mb-2">
                    <img class="d-block w-100" src="<?php echo BASE_URL; ?>/public/image/a1.jpg" alt="jpg slide">
                </div>
                <div class="row">
                    <img class="d-block w-100" src="<?php echo BASE_URL; ?>/public/image/a2.png" alt="Second slide">
                </div>
            </div>
        </div>
